...
impl Instruction {
    ...
    fn encode_f0(opcode: OpCode, a: Register, b: u32, c: Register) -> u32 {
        // 00(2) [op](4) a(4) b(4) padding(14) c(4)
        return (opcode as u32) * (2 as u32).pow(32 - 2 - 4)
            |  (a as u32) * (2 as u32).pow(32 - 2 - 4 - 4)
            |  (b as u32) * (2 as u32).pow(32 - 2 - 4 - 4 - 4)
            |  (c as u32)
            as u32;
    }
...
mod tests {
    ...
    fn assert_encoded(inst: Instruction, expected : u32) {
        let actual: u32 = Instruction::encode(inst);
